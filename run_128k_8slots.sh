#!/usr/bin/env bash
# run_128k_8slots.sh: 128K Context with 8-way Concurrent Decode Streams on 4x A100 GPUs
# Context: 131,072 (128K tokens)
# Concurrency: 8 parallel decode streams (max_seqs 9 = slot 0 prefill scratchpad + slots 1..8 decode)
...
# 8 Concurrent Decode Streams (max_seqs 9: slot 0 scratchpad + slots 1..8 concurrent decode)
