#!/usr/bin/env bash
# run_24slots.sh: 24-way Concurrent Decode Streams on 4x A100 GPUs
# Context: 32,768 (32K tokens)
# Concurrency: 24 parallel decode streams (max_seqs 25 = slot 0 scratchpad + slots 1..24 decode)
set -eo pipefail
...
# 32K Context Horizon
export DSV41_EP_GRAPH_TOKENS=16384
export DSV41_EP_CAND_TOKENS=16384
export DSV41_CACHE_INIT_TOKENS=16384
export DSV41_EP_PREALLOC_TOKENS=16384
export DSV41_EXACT_CACHE_GROW=1

# 24 Concurrent Decode Streams (max_seqs 25: slot 0 scratchpad + slots 1..24 concurrent decode)
export DSV41_MAX_SEQS=25
