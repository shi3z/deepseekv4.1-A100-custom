#!/usr/bin/env bash
# run_32slots.sh: 32-way Concurrent Decode Streams on 4x A100 GPUs
# Context: 16,384 (16K tokens)
# Concurrency: 32 parallel decode streams (max_seqs 33 = slot 0 scratchpad + slots 1..32 decode)
set -eo pipefail
...
# 32 Concurrent Decode Streams (max_seqs 33: slot 0 scratchpad + slots 1..32 concurrent decode)
export DSV41_MAX_SEQS=33
