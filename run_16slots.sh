#!/usr/bin/env bash
# run_16slots.sh: 16-way Concurrent Decode Streams on 4x A100 GPUs
# Context: 32,768 (32K tokens)
# Concurrency: 16 parallel decode streams (max_seqs 17 = slot 0 scratchpad + slots 1..16 decode)
set -eo pipefail
...
# 16 Concurrent Decode Streams (max_seqs 17: slot 0 scratchpad + slots 1..16 concurrent decode)
export DSV41_MAX_SEQS=17
